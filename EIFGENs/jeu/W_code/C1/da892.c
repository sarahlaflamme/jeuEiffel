...
extern EIF_TYPED_VALUE F892_8288(EIF_REFERENCE);
extern EIF_TYPED_VALUE F892_8289(EIF_REFERENCE);
extern EIF_TYPED_VALUE F892_8290(EIF_REFERENCE);
...
EIF_TYPED_VALUE F892_8288 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F892_8289 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F892_8290 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 891, Current, 0, 0, 13832);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(891, Current, 13832);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTNHOOK(1,1);
	tr8_1 = *(EIF_REAL_64 *)(tr1 + RTVA(6120, "fractional_second", tr1));
