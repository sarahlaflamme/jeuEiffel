...
extern EIF_TYPED_VALUE F877_8102(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8103(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8104(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8105(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8106(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8107(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8108(EIF_REFERENCE);
extern EIF_TYPED_VALUE F877_8109(EIF_REFERENCE);
...
EIF_TYPED_VALUE F877_8102 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F877_8102,13666,RTMS_EX_H("English",7,257590376));
}

/* {DATE_TIME_TOOLS}.days_text */
RTOID (F877_8103)
EIF_TYPED_VALUE F877_8103 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 876, Current, 0, 0, 13666);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(876, Current, 13666);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
RTOID (F877_8104)
EIF_TYPED_VALUE F877_8104 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 876, Current, 0, 0, 13667);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(876, Current, 13667);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F5, 0,0); /* Result */
...
RTOID (F877_8105)
EIF_TYPED_VALUE F877_8105 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 876, Current, 0, 0, 13668);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(876, Current, 13668);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F5, 0,0); /* Result */
...
RTOID (F877_8106)
EIF_TYPED_VALUE F877_8106 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 876, Current, 0, 0, 13669);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(876, Current, 13669);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000F5, 0,0); /* Result */
...
EIF_TYPED_VALUE F877_8107 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F877_8107,13671,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F877_8108 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F877_8108,13672,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F877_8109 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F877_8109,13673,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}

void EIF_Minit877 (void)
{
	GTCX
	RTOTS (8102,F877_8102)
	RTOTS (8103,F877_8103)
	RTOTS (8104,F877_8104)
	RTOTS (8105,F877_8105)
	RTOTS (8106,F877_8106)
	RTOTS (8107,F877_8107)
	RTOTS (8108,F877_8108)
	RTOTS (8109,F877_8109)
}
